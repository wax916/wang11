...
(function($) {
	...
	function Register() {
		...
		this._validate = function() {
			...
			// 医疗机构执业许可证校验
//			if (!_this._isEmty(_this.regiterData.practicingLicenseNo)) {
//				var $this = $('#practicingLicenseNo');
//				$this.addClass("txt-error");
//			}
//			if (!_this._isEmty(_practicingLicensePath)) {
//				var $this = $('#practicingRegister').parent();
//				$this.addClass("txt-error");
//			}
//			if (!_this._isEmty(_practicingLicenseFPath)) {
//				var $this = $('#practicingRegister1').parent();
//				$this.addClass("txt-error");
//			}
//			if (!_this._isEmty(_practicingLicenseF2Path)) {
//				var $this = $('#practicingRegister2').parent();
//				$this.addClass("txt-error");
//			}
